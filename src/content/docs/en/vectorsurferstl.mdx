...
For Weaviate Cloud (WCS) connections, add `WEAVIATE_API_KEY`. See the [VectorWave Installation](/docs/vectorwave-installation) guide for the full environment variable reference.
...
- [GitHub: Cozymori/VectorSurferSTL](https://github.com/Cozymori/VectorSurferSTL) — Source code, issues, and pull requests
- [PyPI: vectorsurferstl](https://pypi.org/project/vectorsurferstl/) — Package page
