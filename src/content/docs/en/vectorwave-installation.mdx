...
This creates two collections in Weaviate:
...
If you upgrade VectorWave and the schema changes, use:
...
This performs zero-downtime migration — existing data is preserved.
